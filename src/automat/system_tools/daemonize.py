...
################################################################################
def detach(stdin='/dev/null', stdout='/dev/null', stderr='/dev/null'):
    ''' Will detach a process from controlling terminal'''
    #ignore the HANGUP signal sent when the terminal window closes    
